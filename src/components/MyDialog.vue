...
<template>
  <q-dialog v-model:model-value="props.isDialog" persistent>
    <q-card>
      <q-card-section>
        <div class="text-h6">{{ props.dialogTitle }}</div>
      </q-card-section>
      <q-card-section class="q-pt-none form">
        <q-form @submit.prevent="onConfirm">
          <div style="max-width: 300px;">
            ...
            <!-- 新密码输入 -->
            <q-input bottom-slots v-model="form.new_password" label="新密码" :type="isPwd ? 'password' : 'text'"
            ...
            <!-- 确认密码输入 -->
            <q-input bottom-slots v-model="form.confirm_password" label="确认新密码" :type="isPwd ? 'password' : 'text'"
